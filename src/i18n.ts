  ...
  en: {
    ...
    pages: {
      ...
      wisdom: {
        ...
        mockNotice: "Interaction mock — no API calls yet",
        newButton: "New",
        ...
        unresolvedWikilink: "[[{title}]] isn't a wisdom page in this mock.",
        cancel: "Cancel",
        create: "Create",
  ...
  "zh-CN": {
    ...
    pages: {
      ...
      wisdom: {
        ...
        unresolvedWikilink: "[[{title}]] 不是当前 mock 中的认知页面。",
        cancel: "取消",
        create: "创建",
        discard: "放弃修改",
