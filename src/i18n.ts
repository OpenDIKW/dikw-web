  ...
  en: {
    ...
    pages: {
      ...
      graph: {
        ...
        pathMode: "Path mode",
        pathSelectSource: "Select a source node",
        pathSelectTarget: "select a target node",
        pathLinkUnit: "link",
        pathUnreachable: "No path found",
  ...
  "zh-CN": {
    ...
    pages: {
      ...
      graph: {
        ...
        hideOrphans: "隐藏孤立节点",
        pathMode: "路径模式",
        pathSelectSource: "选择起点节点",
        pathSelectTarget: "选择目标节点",
        pathLinkUnit: "条链接",
        pathUnreachable: "未找到路径",
        resetFocus: "重置聚焦",
        openInWiki: "在知识库打开",
        loadingGraph: "正在加载图谱",
        readingPages: "读取",
