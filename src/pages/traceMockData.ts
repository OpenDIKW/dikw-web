...
export const mockTraceSessions: AgentSession[] = [
  {
    ...
    sources: [
      {
        path: "knowledge/concepts/dikw-architecture.md",
        title: "DIKW Architecture",
        layer: "knowledge",
        score: 0.91,
      },
    ],
    ...
    invocations: [
      {
        ...
        spans: [
          ...
          },
          {
            ...
            status: "ok",
            attributes: {
              "gen_ai.agent.name": "dikw_agent",
              "gen_ai.conversation.id": "trace-demo-architecture",
            },
          },
          {
            spanId: "s2",
          ...
          },
          {
            ...
            attributes: {
              ...
              error: "web_search requires DIKW_AGENT_TAVILY_API_KEY",
            },
          },
          {
            spanId: "s5",
    ...
    invocations: [
      {
        ...
        spans: [
          ...
          },
          {
            ...
            attributes: {
              "gen_ai.agent.name": "dikw_agent",
              "gen_ai.conversation.id": "trace-demo-wisdom",
            },
          },
          {
            spanId: "w2",
